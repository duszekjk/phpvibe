...
class EditSession(models.Model):
    ...
    copy_stage = models.CharField(max_length=120, blank=True)
    copy_bytes_total = models.PositiveBigIntegerField(default=0)
    copy_bytes_done = models.PositiveBigIntegerField(default=0)
    copy_files_total = models.PositiveIntegerField(default=0)
    copy_files_done = models.PositiveIntegerField(default=0)
